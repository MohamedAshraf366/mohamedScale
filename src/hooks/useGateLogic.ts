// src/hooks/useGateLogic.ts - نسخة كاملة ومحدثة
...
export const GATES: GateInfo[] = [
  { id: 'G1', label: 'Customer Quote', requirement: 'Customer must accept the quote', icon: CheckCircle2, order: 1 },
...
// خطوات Procurement المتوافقة مع الـ Gates
  ...
  const getPendingAction = (): PendingAction | null => {
    ...
    switch (currentGate) {
      case 'G1':
        return {
          gate: 'G1',
          title: 'Customer Quote Pending',
          description: 'Customer needs to accept the quote to proceed.',
